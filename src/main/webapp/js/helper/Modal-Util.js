 ...
 * Modal Utility for Showing bottstrap Modal using Knockout binding.
 */    

define(['jquery','knockout'], function($,ko) {
    'use strict';
    var Modal = function() {};
    Modal.prototype.showModal = function(options) {
        ...
        ko.renderTemplate(
            ...
            // The resolve function receives the element.
            {
                afterRender: function (nodes) {
                    ...
                    $("#inputTitle,#inputText").parent().parent().removeClass('has-error');
                    $('#inputTitle,#inputText').on('keyup',function(){
    ...
    var whenModalResultCompleteThenHideUI = function (deferredModalResult, $ui) {
        // When mod al is closed (with or without a result)
